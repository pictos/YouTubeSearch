    ...
    public static class DownloadUrlResolver
    {
        ...
        public static void DecryptDownloadUrl(VideoInfo videoInfo)
        {
            ...
            if (queries.ContainsKey(SignatureQuery))
            {
                ...
                {
                    throw new ParseException("Could not decipher signature", ex);
                }
        ...
        public static bool TryNormalizeYoutubeUrl(string url, out string normalizedUrl)
        {
            ...
            if (!query.TryGetValue("v", out string v))
            {
                normalizedUrl = null;
                return false;
            }
        ...
        {
            string[] splitByUrls = GetStreamMap(json);
            string[] adaptiveFmtSplitByUrls = GetAdaptiveStreamMap(json);
        ...
        {
            JToken streamMap = json["streamingData"]["formats"];
        ...
        private static void ThrowYoutubeParseException(Exception innerException, string videoUrl)
        {
            throw new ParseException("Could not parse the Youtube page for URL " + videoUrl + "\n" +
                                            ...
                                            "Please report this bug at www.github.com/mrklintscher/YoutubeSearch/issues", innerException);
        }
